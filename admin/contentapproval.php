                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                         <?php 
                                             ...
                                             $qry = "SELECT ID,LessonName,Description,Video,Confirm  from tbllesson where Active='No'";
                                            ...
                                            echo "
                                                ...
                                                <td>
                                                    ...
                                                    <a href='acceptlesson.php?ID=$id'>Accept</a>
                                                    <a href='rejectlesson.php?ID=$id'>Reject</a>
