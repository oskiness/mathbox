                        ...
                        <!-- /.panel-heading -->
                                <div class="row">
                                    <div class="panel-body">
                                        ...
                                        <a style="float:right; padding-right:10px;" href="addsection.php"><img src="img/user_add.png" height="30px" style="float:center; padding-left:20px;" ><br>Add section</a><br><br>
                                        ...
                                        <tbody>
                                         <?php 
                                            ...
                                            echo "
                                                ...
                                                <td>
                                                    <a href='editsection.php?ID=$id'>Edit</a>
                                                    <a href='deletesection.php?ID=$id'>Delete</a>
