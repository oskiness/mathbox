...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><center>Teacher Archive</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                         <?php 
                                             ...
                                             $qry = "SELECT TeacherID,Username,Password,Firstname,Lastname,Middlename,Email,Section from teacher_login where Active='No'";
                                            ...
                                            echo "
                                                ...
                                                <td>
                                                    <a href='restoreteacher.php?TeacherID=$id'>Restore</a>
                                                    <a href='totallydeleteteacher.php?TeacherID=$id'>Delete</a>
