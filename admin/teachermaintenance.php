...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><center>Teacher List</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <!-- /.panel-heading -->
                                <div class="row">
                                    <div class="panel-body">
                                        ...
                                        <a style="float:right; padding-right:10px;" href="addteacher.php"><img src="img/user_add.png" height="30px" style="float:center; padding-left:20px;" ><br>Add teacher</a><br><br>
                                        ...
                                        <tbody>
                                         <?php 
                                            ...
                                            echo "
                                                ...
                                                <td>
                                                    <a href='editteacher.php?TeacherID=$id'>Edit</a>
                                                    <a href='deleteteacher.php?TeacherID=$id'>Delete</a>
