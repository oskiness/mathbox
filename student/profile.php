...
<html lang="en-US">
   <head>
      ...
      <link href='http://fonts.googleapis.com/css?family=Ope<:400,300,600,700,800&subset=latin,latin-ext' rel='stylesheet' type='text/css'>
         ...
         <section>
            ...
            <div class="container">
              ...
              <center><h1>User Profile</h1></center>
                <div class="col-md-5  toppad  right col-md-offset-3 ">
                ...
                <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xs-offset-0 col-sm-offset-0 col-md-offset-3 col-lg-offset-3 toppad" >
                  ...
                  <div class="panel panel-info">
                    <div class="panel-heading">
                      <h3 class="panel-title">&nbsp;<?php echo $fname?> <?php echo $mname?> <?php echo $lname?> </h3>
                    </div>
