...
<body>
    ...
    <div id="wrapper">
                        ...
                        <li>
                          ...
                          <li>
                            ...
                            <ul class="nav nav-second-level">
                                ...
                                <li>
                                    <a href="teacherarchive.php">Lesson Archive</a>
                                </li>
                                <li>
                                    <a href="sectionarchive.php">Quiz Archive</a>
                                </li>
                            </ul>
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><center>Welcome to Teacher Page , <?php echo $admin; ?></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
