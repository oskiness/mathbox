...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Adding Quiz</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form method="POST" action="addquizexe.php">
                                        <div class="form-group">
                                            <label>Question</label>
                                            <textarea name="question" required class="form-control" placeholder="Enter text"></textarea>
                                        </div>
                                        <div class="form-group">
                                            <label>Choice 1</label>
                                            <input name="answer1" required class="form-control" placeholder="Enter text">
                                        </div>
                                        <div class="form-group">
                                            <label>Choice 2</label>
                                            <input name="answer2" required class="form-control" placeholder="Enter text">
                                        </div>
                                        <div class="form-group">
                                            <label>Choice 3</label>
                                            <input name="answer3" required class="form-control" placeholder="Enter text">
                                        </div>
                                        <div class="form-group">
                                            <label>Choice 4</label>
                                            <input name="answer4" required class="form-control" placeholder="Enter text">
                                        </div>
                                        <div class="form-group">
                                            <label>Correct Answer</label>
                                            <input name="final_answer" required class="form-control" placeholder="Enter text">
                                        </div>
