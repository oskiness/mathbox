                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                         <?php 
                                             ...
                                             $qry = "SELECT ID,LessonName,Description,Video,Confirm from tbllesson where Active='Yes' and Confirm = 'Deleted'";
                                            ...
                                            echo "
                                                ...
                                                <td>
                                                    <a href='restorelesson.php?ID=$id'>Restore</a>
                                                    <a href='totallydeletelesson.php?ID=$id'>Delete</a>
