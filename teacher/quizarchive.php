...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><center>Question List</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                        ...
                        <!-- /.panel-heading -->
                                <div class="row">
                                    <div class="panel-body">
                                        ...
                                        <a style="float:right; padding-right:10px;" href="addquiz.php"><img src="img/addquiz.png" height="30px" style="float:center; padding-left:10px;" ><br>Add Quiz</a><br><br>
                                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                        ...
                                        <tbody>
                                         <?php 
                                             ...
                                             $qry = "SELECT ID,Question,Choice1,Choice2,Choice3,Choice4,Answer  from tblpretest where Active='No'";
                                            ...
                                            echo "
                                                ...
                                                <td>
                                                    <a href='restorequiz.php?ID=$id'>Restore</a>
                                                    <a href='deletequiz.php?ID=$id'>Delete</a>
